...
$router->map('GET|POST', '/del_Pc/i:pc_id', function($pc_id){ // Si on dois effectuer une action et non rediriger ver une autre page alors on lance une fonction dans le mapping
    header('Location: /connexion');
    exit();
});
$match = $router->match();